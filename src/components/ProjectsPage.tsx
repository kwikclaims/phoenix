...
export const ProjectsPage: React.FC<ProjectsPageProps> = ({ onNavigate }) => {
  ...
  const fetchProjects = async () => {
    ...
    try {
      ...
      console.log("[ProjectsPage] Raw rows:", rows);
      ...
      console.log("[ProjectsPage] Parsed projects:", parsedProjects);
      ...
      toast.error("Failed to load projects from Google Sheets");
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-red-50 border border-red-200 rounded-xl p-6 text-center">
          ...
          <h2 className="text-xl font-bold text-red-800 mb-2">Failed to Load Projects</h2>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!loading && filteredProjects.length === 0 && projects.length === 0 && (
          <div className="text-center py-24 animate-fade-in-up animate-delay-500">
            ...
            <h2 className="text-2xl sm:text-4xl font-bold text-white mb-3">No Projects Found</h2>
            <p className="text-gray-400 mb-8 max-w-md mx-auto">
              No project data could be loaded from the Google Sheet.
            </p>
            <button 
              onClick={handleRefresh}
