    ...
    >
      <div style={{ marginBottom: '24px' }}>
        <p style={{ marginBottom: '16px' }}>
          Generate a detailed construction invoice using Xactimate market pricing.
          ...
          The invoice must reflect the exact dollar amount, with no rounding.
          All line items should follow Xactimate formatting and structure.
        </p>

        <p style={{ marginBottom: '16px' }}>
          <strong>Context:</strong> [Field Input]
        </p>
      </div>

      <div style={{ marginBottom: '24px' }}>
        <h2 style={{ fontSize: '16px', fontWeight: 'bold', marginBottom: '16px' }}>
          PHOENIX INVOICE FORMAT SPECIFICATION
        </h2>
        <p style={{ marginBottom: '16px' }}>
          This is a layout guide for a clean, insurer-compliant PDF invoice.
        </p>
      </div>
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <div style={{ marginBottom: '16px', lineHeight: '1.4' }}>
          ...
          <p style={{ marginBottom: '4px' }}>MHIC #05-164678 | Rep Name: [Field Input] | Rep Phone [Field Input] | Rep Email: [Field Input]</p>
        </div>
      ...
      <div style={{ marginBottom: '24px' }}>
        <h3 style={{ fontSize: '14px', fontWeight: 'bold', marginBottom: '12px' }}>
          2. Invoice Information Block
        </h3>
        <div style={{ marginBottom: '16px', lineHeight: '1.4' }}>
          <p>Invoice #: [Alphanumeric ID]</p>
      ...
      <div style={{ marginBottom: '24px' }}>
        <h3 style={{ fontSize: '14px', fontWeight: 'bold', marginBottom: '12px' }}>
          5. Page Handling for Multi-Page Invoices
        </h3>
        <ul style={{ marginLeft: '20px', marginBottom: '0' }}>
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <div style={{ marginBottom: '16px', lineHeight: '1.4' }}>
          <p><strong>Total Invoice: $XX,XXX.XX</strong></p>
          <p>Invoice Date: [Month DD, YYYY]</p>
        ...
        <div style={{ marginBottom: '16px' }}>
          <p style={{ fontWeight: 'bold', marginBottom: '8px' }}>Formatting:</p>
          <ul style={{ marginLeft: '20px', marginBottom: '0' }}>
            <li>Bold only the "Total Invoice:" label and amount.</li>
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <p style={{ marginBottom: '16px' }}>
          This invoice reflects storm-related damages observed on-site and incorporates all required materials, labor, and code upgrades necessary to return the property to pre-loss condition. Steep slope, elevation, and material-specific pricing have been applied in accordance with [Pricing Code] database.
        </p>
        
        <div style={{ marginBottom: '16px' }}>
          <p style={{ fontWeight: 'bold', marginBottom: '8px' }}>Formatting:</p>
          <ul style={{ marginLeft: '20px', marginBottom: '0' }}>
            <li>Plain paragraph placed immediately above the Total Invoice block.</li>
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <ul style={{ marginLeft: '20px', marginBottom: '16px' }}>
          ...
          <li>Bolding: Company name and Total Invoice line must be bold.</li>
          ...
          <li>Filename Format: [CustomerLastName]_[Claim#]_PRCS_Invoice_[YYYY-MM-DD].pdf</li>
        </ul>
      </div>
